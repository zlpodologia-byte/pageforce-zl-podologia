...
export const exactPricingCards: readonly ExactPricingCard[] = [
  ...
  },
  {
    title: "Podoprofilaxia",
    price: "R$ 129",
    body: "Higienizacao completa, remocao de calosidades e prevencao.",
    action: "Agendar agora",
    tone: "highlight",
  },
  {
    title: "Unha Encravada",
    price: "de R$ 149 a R$ 199",
    body: "Tratamento conservador com alivio da dor e correcao.",
    action: "Agendar agora",
  },
  {
    title: "Fungos nas Unhas",
    price: "R$ 149 / sessao",
    body: "Laser + ativos + acompanhamento para resultados eficaces.",
    action: "Agendar agora",
  },
  {
    title: "Reflexologia Podal",
    price: "R$ 139",
    body: "Tecnica de massagem que promove relaxamento e bem-estar.",
    action: "Agendar agora",
  },
  {
    title: "Pe Diabetico",
    price: "R$ 139",
    body: "Cuidados especializados para prevencao de lesoes e complicacoes.",
    action: "Agendar agora",
  },
] as const;
