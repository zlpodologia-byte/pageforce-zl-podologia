...
export function ZlHeroArtwork() {
  return (
    <div className="relative aspect-[0.92] overflow-hidden rounded-[2.4rem] border border-[#D9DAD7] bg-[linear-gradient(165deg,#FFFFFF_0%,#D9DAD7_100%)] shadow-[0_40px_90px_rgba(23,79,63,0.18)]">
      ...
      >
        <defs>
          <linearGradient id="zl-hero-basin" x1="0" y1="0" x2="0" y2="1">
            ...
            <stop offset="1" stopColor="#D9DAD7" />
          </linearGradient>
        ...
        {/* Delicate plant stem */}
        <path d="M586 120c-6 40 2 80 30 108" fill="none" stroke="#8EA08E" strokeWidth="3" strokeLinecap="round" opacity="0.75" />
        <path d="M586 140c-14 0-24 10-26 24 10-2 22-6 26-24z" fill="#8EA08E" opacity="0.8" />
        <path d="M598 176c-14 6-18 18-16 30 12-6 20-16 16-30z" fill="#8EA08E" opacity="0.75" />
      ...
      <GlassNote className="left-5 top-5 max-w-[12.5rem]" tone="rose">
        ...
        <p className="mt-2 text-[0.95rem] leading-[1.4] text-[#26302B]">
      ...
      <GlassNote className="right-5 top-5 max-w-[12rem]" tone="blue">
        <div className="flex items-center gap-1 text-[#8EA08E]">
          {[0, 1, 2, 3, 4].map((i) => (
...
export function ZlServiceArtwork({
  ...
  return (
    <div className="relative overflow-hidden rounded-[1.9rem] border border-[#D9DAD7] bg-[linear-gradient(180deg,#FFFFFF_0%,#EFEAE4_100%)] p-6 shadow-[0_24px_60px_rgba(23,79,63,0.12)]">
      ...
      <div className="relative">
        <div className="flex items-center justify-between gap-4">
          <div>
            <p className="text-[0.64rem] uppercase tracking-[0.24em] text-[#6F746F]">{label}</p>
            <h3
              className="mt-2 text-[1.55rem] leading-[1.02] tracking-[-0.03em] text-[#26302B]"
              style={{ fontFamily: "var(--font-display)", fontWeight: 400 }}
            >
              {title}
            </h3>
          </div>
          <span className="rounded-full border border-white/80 bg-white/80 px-3 py-1.5 text-[0.64rem] uppercase tracking-[0.18em] text-[#26302B] shadow-[0_10px_28px_rgba(23,79,63,0.08)]">
            Interativo
          </span>
        </div>

        <div className="mt-6 overflow-hidden rounded-[1.4rem] border border-[#D9DAD7] bg-white/90">
...
function IngrownSvg() {
  return (
    <svg viewBox="0 0 640 340" className="h-auto w-full" aria-hidden="true">
      <rect width="640" height="340" fill="#F8F7F4" />
      <circle cx="180" cy="170" r="110" fill={palette.blush} opacity="0.7" />
      <circle cx="460" cy="170" r="110" fill={palette.ice} opacity="0.9" />
      {/* Before */}
      <text x="180" y="68" textAnchor="middle" fontSize="12" fill="#0F6B46" letterSpacing="3">ANTES</text>
      <path d="M130 200c0-52 22-96 58-118 22-14 44-16 66-4" fill="#FCE0D1" stroke={palette.ink} strokeWidth="3" />
      <path d="M160 156c8-8 20-8 28 0 6 6 4 18-2 22-8 4-22 0-26-10-2-4 0-8 0-12z" fill="#174F3F" />
      <path d="M164 152l-4 8" stroke={palette.ink} strokeWidth="2" strokeLinecap="round" />
      <circle cx="172" cy="150" r="3" fill={palette.ink} />
      {/* pain waves */}
      <path d="M210 110c10-6 22-4 30 4" fill="none" stroke="#174F3F" strokeWidth="3" strokeLinecap="round" />
      <path d="M220 96c12-4 24 0 32 8" fill="none" stroke="#174F3F" strokeWidth="3" strokeLinecap="round" />

      {/* After */}
      <text x="460" y="68" textAnchor="middle" fontSize="12" fill="#8EA08E" letterSpacing="3">DEPOIS</text>
      ...
      {/* arrow */}
      <path d="M300 170h40m0 0l-10-8m10 8l-10 8" fill="none" stroke="#6F746F" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function FungusSvg() {
  return (
    <svg viewBox="0 0 640 340" className="h-auto w-full" aria-hidden="true">
      ...
      {/* timeline */}
      <path d="M70 230h500" stroke="#D9DAD7" strokeWidth="3" strokeLinecap="round" strokeDasharray="4 8" />
      {[80, 250, 420, 560].map((x, i) => (
        <g key={x}>
          <circle cx={x} cy="230" r="10" fill={i === 0 ?"#174F3F" : i === 3 ?"#8EA08E" : "#D9DAD7"} />
          <text x={x} y="262" textAnchor="middle" fontSize="11" fill="#6F746F">
      ...
      {[80, 250, 420, 560].map((x, i) => (
        <g key={`n-${x}`}>
          ...
          {i === 0 && (
            <>
              <circle cx={x - 6} cy={165} r="4" fill="#6F746F" opacity="0.65" />
              <circle cx={x + 6} cy={180} r="3" fill="#6F746F" opacity="0.55" />
            </>
          )}
          {i === 1 && <circle cx={x} cy={172} r="3" fill="#6F746F" opacity="0.4" />}
        </g>
      ))}
      {/* header */}
      <text x="70" y="70" fontSize="13" fill="#0F6B46" letterSpacing="3">PROTOCOLO</text>
      <text x="70" y="96" fontSize="18" fill="#26302B" fontFamily="var(--font-display)">Evolucao progressiva</text>
    </svg>
  );
}
      ...
      <g transform="translate(420 50)">
        {[
          ...
          <g key={item.label} transform={`translate(0 ${item.y})`}>
            <circle cx="12" cy="12" r="11" fill="#0F6B46" opacity="0.8" />
            <path d="M7 12l3 3 7-7" fill="none" stroke="#ffffff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
            <text x="32" y="16" fontSize="13" fill="#26302B">{item.label}</text>
          </g>
        ))}
      </g>
    </svg>
...
function OrthosisSvg() {
  return (
    <svg viewBox="0 0 640 340" className="h-auto w-full" aria-hidden="true">
      <rect width="640" height="340" fill="#FFFFFF" />
      <text x="160" y="60" textAnchor="middle" fontSize="11" fill="#0F6B46" letterSpacing="3">CURVATURA ATUAL</text>
      <text x="480" y="60" textAnchor="middle" fontSize="11" fill="#8EA08E" letterSpacing="3">COM ORTESE</text>

      {/* Before - curved in */}
      <rect x="120" y="100" width="80" height="140" rx="30" fill="#C9B89A" stroke={palette.ink} strokeWidth="2" />
      <path d="M140 120c8 16 8 36 0 52" fill="none" stroke="#174F3F" strokeWidth="3" />
      <path d="M180 120c-8 16-8 36 0 52" fill="none" stroke="#174F3F" strokeWidth="3" />
      {/* arrows pushing in */}
      <path d="M100 146l16 6m0-12l-16 6" fill="none" stroke="#174F3F" strokeWidth="2" strokeLinecap="round" />
      <path d="M220 146l-16 6m0-12l16 6" fill="none" stroke="#174F3F" strokeWidth="2" strokeLinecap="round" />

      {/* arrow center */}
      <path d="M270 170h60m0 0l-12-10m12 10l-12 10" fill="none" stroke="#6F746F" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
      ...
      {/* orthosis piece */}
      <path d="M452 126c22-4 44-4 66 0l-4 8c-20-4-38-4-58 0z" fill="#0F6B46" opacity="0.7" />
    </svg>
  );
}
...
function LaserSvg() {
  return (
    <svg viewBox="0 0 640 340" className="h-auto w-full" aria-hidden="true">
      <rect width="640" height="340" fill="#FFFFFF" />
      {/* laser device */}
      <rect x="60" y="140" width="110" height="40" rx="14" fill="#26302B" />
      <circle cx="170" cy="160" r="6" fill="#174F3F" />
      {/* laser beam */}
      ...
      <defs>
        <linearGradient id="laser-beam" x1="0" y1="0" x2="1" y2="0">
          <stop offset="0" stopColor="#174F3F" stopOpacity="0.9" />
          <stop offset="1" stopColor="#174F3F" stopOpacity="0.1" />
        </linearGradient>
      </defs>
      {/* foot target */}
      <path
      ...
      />
      {/* target glow */}
      <circle cx="400" cy="222" r="24" fill="#174F3F" opacity="0.2" />
      <circle cx="400" cy="222" r="12" fill="#174F3F" opacity="0.35" />
      <circle cx="400" cy="222" r="5" fill="#174F3F" />

      <text x="60" y="110" fontSize="13" fill="#0F6B46" letterSpacing="2">LASER DE APOIO</text>
    </svg>
  );
}
      ...
      <g transform="translate(430 70)">
        {[
          ...
          <g key={item} transform={`translate(0 ${i * 44})`}>
            <circle cx="12" cy="12" r="11" fill="#0F6B46" opacity="0.85" />
            <path d="M7 12l3 3 7-7" fill="none" stroke="#ffffff" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
            <text x="32" y="16" fontSize="13" fill="#26302B">{item}</text>
          </g>
        ))}
      </g>
    </svg>
...
function ReflexologySvg() {
  return (
    <svg viewBox="0 0 640 340" className="h-auto w-full" aria-hidden="true">
      ...
      <g opacity="0.9">
        <circle cx="230" cy="128" r="8" fill="#0F6B46" />
        <circle cx="260" cy="118" r="6" fill="#0F6B46" opacity="0.8" />
        <circle cx="290" cy="122" r="7" fill="#174F3F" opacity="0.8" />
        <circle cx="215" cy="170" r="6" fill="#8EA08E" opacity="0.85" />
        <circle cx="260" cy="180" r="8" fill="#174F3F" opacity="0.75" />
        <circle cx="305" cy="172" r="6" fill="#0F6B46" opacity="0.85" />
        <circle cx="240" cy="220" r="7" fill="#8EA08E" opacity="0.85" />
        <circle cx="285" cy="215" r="6" fill="#0F6B46" opacity="0.8" />
      </g>
      {/* Waves of relaxation on the right */}
      <g stroke="#0F6B46" strokeWidth="2" strokeLinecap="round" fill="none" opacity="0.55">
      ...
      <g transform="translate(430 170)">
        {[
          { label: "Menos estresse", color: "#174F3F" },
          { label: "Menos cansaco", color: "#174F3F" },
          { label: "Menos ansiedade", color: "#8EA08E" },
          { label: "Mais pausa", color: "#0F6B46" },
        ].map((item, i) => (
          <g key={item.label} transform={`translate(0 ${i * 30})`}>
            <circle cx="8" cy="10" r="6" fill={item.color} />
            <text x="24" y="14" fontSize="13" fill="#26302B">{item.label}</text>
          </g>
        ))}
      </g>
...
function CaseHalf({
  ...
  // v7-earthy: ANTES em taupe (#D9DAD7) com label marrom escuro, DEPOIS
  // em areia claro (#F8F7F4) com label verde-oliva.
  ...
  return (
    <div className="p-5" style={{ background }}>
          ...
          {tone === "before" ?(
            <>
              <path
                ...
                strokeWidth="2.5"
              />
              <circle cx="150" cy="52" r="10" fill="#174F3F" />
              <path d="M168 38c6-4 14-2 18 4" fill="none" stroke="#174F3F" strokeWidth="2" strokeLinecap="round" />
            </>
          ) : (
            <>
              <path
      ...
      <p className="mt-4 text-[0.92rem] leading-[1.6]" style={{ color: "#26302B" }}>{body}</p>
    </div>
  );
}
...
function GlassNote({
  ...
  const ring =
    tone === "blue" ?"ring-[#D9DAD7]" : "ring-[#EFEAE4]";
  return (
    <div
      className={`absolute rounded-[1.3rem] bg-white/88 p-3.5 shadow-[0_18px_46px_rgba(23,79,63,0.08)] ring-1 backdrop-blur-sm ${ring} ${className}`}
    >
      {children}
    </div>
  );
